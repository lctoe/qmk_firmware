 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  OS  | Tab  |QWERTY|Lower | Bksp |Space |Raise |Number| Left | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_L0] = LAYOUT_planck_grid(
    ...
    LM(_Ctrl, MOD_LCTL), KC_LGUI, KC_TAB,  TG(_QWERTY), MO(_Lower),  KC_BSPC, KC_SPC,  MO(_Raise), TT(_Number), KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_Raise] = LAYOUT_planck_grid(
    KC_MUTE, _______, _______, _______, _______, _______, _______, KC_AMPR, KC_ASTR, _______, _______, KC_BSLS,
    _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, _______, 
...
[_Lower] = LAYOUT_planck_grid(
    ...
    _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, _______, _______, _______, KC_UP,   _______,
...
[_Number] = LAYOUT_planck_grid(
    C(KC_D), KC_GRV,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |  , < |  . > |  / ? | ' "  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |  OS  | Tab  |QWERTY|Spc/Lw| - _  |Space |Raise |Number| Left | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
